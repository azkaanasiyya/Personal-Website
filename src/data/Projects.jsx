...
const Projects = [
  ...
  },
  {
    image: fundsphere,
    title: 'Fundsphere',
    description: 'UX design of the Fundsphere project interface. Web app built using React, Vite and TailwindCSS.',
    link: 'https://fundsphere-ashy.vercel.app/',
  },
  {
    image: finwealth,
    title: 'FinWealth',
    description: 'UX design of the FinWealth interface. Built with React and TailwindCSS.',
    link: '#',
  },
  {
    image: finwealthWordpress,
    title: 'FinWealth',
