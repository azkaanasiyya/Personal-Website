...
function Hero() {
  return (
    <div id="hero" className="bg-primary-300">
        ...
        <div className="hero-wrapper flex items-center justify-between">
          <div className="hero-content flex flex-col gap-6">
            ...
            <div className="hero-text flex flex-col gap-6">
              <p className="max-w-[450px] font-medium text-primary-400">
              ...
              <div className="button-wrapper flex flex-row gap-[15px]">
                ...
                <button className="h-[48px] rounded-full px-[24px] py-[8px] text-sm font-medium border-2 border-primary-400 text-primary-500 hover:bg-primary-400">Browse Project</button>
              </div>
            </div>
          </div>
